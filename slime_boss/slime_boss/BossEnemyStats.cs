...
{
	[CreateAssetMenu(fileName = "NewBossEnemyStats", menuName = "PLAYER TWO/Platformer Project/Enemy/New Boss Enemy Stats")]
	public class BossEnemyStats : EntityStats<EnemyStats>
	{
